...
<head>
 ...
 <title>Envio de correo con PHPMailer - GMail SMTP</title>
</head>
<body>
...
$mail->Username = "ucardena01@gmail.com";
...
$mail->setFrom('ucardena01@gmail.com', 'Uriel!');
$mail->addAddress($row['PersonasEmail'], $row['PersonasNombre']);
 //La linea de asunto
$mail->Subject = 'Hola, esto es un correo automatico enviado dede php';
